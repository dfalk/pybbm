...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('pybb_profile', 'avatar', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Profile.avatar'
        db.alter_column('pybb_profile', 'avatar', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True))
